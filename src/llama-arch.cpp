...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_EMBED_SKIP,                             "blk.%d.embed_skip" },
    { LLM_TENSOR_ATTN_Q_GAIN,                            "blk.%d.attn_q_gain" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_EMBED_SKIP,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_Q_GAIN,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
