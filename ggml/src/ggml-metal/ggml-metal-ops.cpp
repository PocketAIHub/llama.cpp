...
int ggml_metal_op_mul_mat(ggml_metal_op_t ctx, int idx) {
    ...
    if (op->src[1]->type == GGML_TYPE_F32 && (ne00%128 == 0) &&
        ...
        // TurboQuant types don't have mul_mm kernels yet — fall through to mul_mv
        op->src[0]->type != GGML_TYPE_TURBO4 &&
        op->src[0]->type != GGML_TYPE_TURBO3 &&
        op->src[0]->type != GGML_TYPE_TURBO2) {
