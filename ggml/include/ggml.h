...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q1_0    = 41,
        GGML_TYPE_TURBO2  = 42, // TurboQuant 2-bit: 1-bit PolarQuant + 1-bit QJL
        GGML_TYPE_TURBO3  = 43, // TurboQuant 3-bit: 2-bit PolarQuant + 1-bit QJL
        GGML_TYPE_TURBO4  = 44, // TurboQuant 4-bit: 3-bit PolarQuant + 1-bit QJL
        GGML_TYPE_COUNT   = 45,
    };
